  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-2.5 px-4 py-2 rounded-2xl transition-all duration-300 hover:scale-[1.02] active:scale-95 group"
        style={{
        ...
        <div className="relative">
          <div 
            ...
            style={{ 
              ...
              boxShadow: `0 0 10px ${getModelColor(current.id)}50`
            }}
          />
          <div 
      ...
      {open && (
        <div
          className="absolute top-full mt-2 left-0 w-72 rounded-2xl overflow-hidden shadow-2xl animate-fadeInUp"
          style={{
        ...
        >
          ...
          <div className="relative px-4 py-3" style={{ 
            ...
            <div className="flex items-center justify-between">
              <span className="text-[11px] uppercase tracking-wider text-gray-500 font-bold flex items-center gap-2">
              ...
              <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-400 font-mono">
                {AI_MODELS.length} مدل
              </span>
            </div>
          </div>

          {/* لیست مدل‌ها */}
          <div className="p-1.5 max-h-80 overflow-y-auto" style={{
            scrollbarWidth: 'thin',
            ...
            {AI_MODELS.map((model: AIModel) => {
              ...
              return (
                <button
                  ...
                  className={`relative w-full text-right px-3 py-3 flex items-center gap-3 rounded-xl transition-all duration-300 group/model ${
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    <div 
                      className="w-9 h-9 rounded-xl flex items-center justify-center text-xl transition-transform duration-300 group-hover/model:scale-110"
                      style={{
                        background: isSelected 
                  ...
                  <div className="flex-1 relative">
                    <div className="flex items-center gap-2">
                      ...
                      {isSelected && (
                        <span className="text-[9px] px-1.5 py-0.5 rounded-full font-bold bg-blue-500/20 text-blue-400 border border-blue-500/20">
                          فعال
                        </span>
                      )}
                    </div>
